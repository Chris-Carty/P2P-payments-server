...
const initiatePayment = (
  ...
  const body =
    ...
    payerAccountName === null
      ? '{"payment_method":{"type":"bank_transfer","provider_selection":{"type":"user_selected","scheme_selection":{"type":"instant_only","allow_remitter_fee":false}},"beneficiary":{"type":"merchant_account", "account_holder_name": "RVNU","merchant_account_id":"' +
      ...
      : '{"payment_method":{"type":"bank_transfer","provider_selection":{"type":"preselected","scheme_selection":{"type":"instant_only","allow_remitter_fee":false}, "remitter": {"account_identifier": {"type": "sort_code_account_number","sort_code": "' +
        ...
        '"}, "provider_id": "' +
        payerProviderId +
        '","scheme_id": "faster_payments_service"},"beneficiary":{"type":"merchant_account", "account_holder_name": "RVNU","merchant_account_id":"' +
        rvnuMerchantAccountId +
        '", "reference":"' +
        reference +
        '"}},"user":{"id":"' +
