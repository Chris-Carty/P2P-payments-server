...
export const initiateBusinessAccountPayout = async (req, res) => {
  ...
  const body = '{"beneficiary":{"type":"business_account","account_identifier":{"type":"iban"},"reference":"' + reference + '"},"merchant_account_id":"' + rvnuMerchantAccountId + '","amount_in_minor":' + amountRounded + ',"currency":"GBP"}'
